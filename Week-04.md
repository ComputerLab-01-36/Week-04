...
ปรากฎคำว่า hello ติดกัน 2 ตัวโดยไม่เว้นบรรทัด
...
แสดงผลออกมาทางหน้าจอ 2 ประโยค แล้วมีการเว้นบรรทัด
...
Console.Write เป็นการไม่ขึ้นบรรทัด
Console.WriteLine เป็นการขึ้นบรรทัดใหม่
...
มีลักษณะของโอเปอร์เรเตอร์ที่เรียงคำตอบ
...
มีการเรียงกันอย่างเป็นระเบียบตามสเกลในการแบ่ง
...
เกิด error เพราะว่าเราระบุไปในโปรแกรมแล้วว่าให้ใส่เป็นตัวเลข ซึ่งเราให้รับค่าเป็น int 
